...
\begin{figure}[h]
\begin{center}
 \includegraphics[width=.4\linewidth]{Figures/demo_image1} % You can add theoritical graphs
...
\begin{figure}[h]
\begin{center}
 \includegraphics[width=.4\linewidth]{Figures/demo_image1} % You can add Experimental data                                                   picture here.......
...
\begin{figure}[h]
\begin{center}
 \includegraphics[width=.4\linewidth]{Figures/demo_image1} % You can add Experimental graph                                                   picture here.......
...
\begin{figure}[ht]
   \begin{minipage}{0.48\textwidth}
     \centering
     \includegraphics[width=.8\linewidth]{Figures/demo_image2}
